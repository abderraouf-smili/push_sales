...
class WilayaDropDown extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Obx(
      () => !dropController.wilayaready.value
          ? EmptyDropDown("loading ...".tr, hasBorder: hasBorder)
                  ...
                  DropdownMenuItem<int>(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Text(item.code, style: TextStyle(fontSize: fontSize)),
                      ],
                    ),
                  ),
              ],
...
class CityDropDown extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Obx(
      () => !dropController.cityready.value
          ? EmptyDropDown("loading ...".tr, hasBorder: hasBorder)
          : DropdownButtonFormField2(
...
class TypePointVenteDropDown extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // }
    return Obx(
      () => !dropController.listTPVready.value
...
class ActorProfileDropDown extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Obx(
      () => !dropController.listAPready.value
...
class TypePVSearchDropDown extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Obx(
      () => !filterController.listTPVready.value
          ? EmptyDropDown("loading ...", hasBorder: false)
          : DropdownButtonFormField2(
