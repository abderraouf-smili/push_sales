                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(
                            ...
                            color: borderColor(
                              0,
                              warehouseController.page.value,
                            ),
                          ),
                        ),
                      ...
                      return Form(
                        ...
                        child: AlertDialog(
                          ...
                          content: Container(
                            ...
                            color: Colors.white,
                            child: Column(
                              children: List.generate(item.prices!.length + 1, (
                                index,
                              ) {
                                if (index < item.prices!.length) {
                                  ...
                                  TextEditingController priceController =
                                      TextEditingController();
                                  var exist = warehouseController.adjustedPrice
                ...
                leading: Container(
                  ...
                  child: CachedNetworkImage(
                    cacheManager: CacheManager(
                      Config(item.image, stalePeriod: const Duration(days: 7)),
                    ),
                    imageUrl: item.image,
