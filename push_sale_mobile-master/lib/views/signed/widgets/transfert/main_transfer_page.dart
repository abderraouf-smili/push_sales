...
class MainTransferPage extends StatelessWidget {
  ...
  final StockOperationController stockController =
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              border: Border.all(
                                width: 1,
                                color:
                                    borderColor(0, stockController.page.value),
                              ),
                            ),
                            child: Center(
                              child: Text(
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              border: Border.all(
                                width: 1,
                                color:
                                    borderColor(1, stockController.page.value),
                              ),
                            ),
                            child: Center(
                              child: Text(
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              border: Border.all(
                                width: 1,
                                color:
                                    borderColor(2, stockController.page.value),
                              ),
                            ),
                            child: Center(
                              child: Text(
